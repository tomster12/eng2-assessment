...
import uk.ac.york.cs.eng2.offers.Writer;

/**
 * This is the item provider adapter for a {@link uk.ac.york.cs.eng2.offers.Writer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WriterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OffersPackage.Literals.WRITER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OffersPackage.Literals.WRITER__BOOKS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Writer.class)) {
			case OffersPackage.WRITER__NAME:
