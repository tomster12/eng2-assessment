...
public class CategoryItemProvider 
	...
	protected void addContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_container_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_container_feature", "_UI_Category_type"),
				 OffersPackage.Literals.CATEGORY__CONTAINER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OffersPackage.Literals.CATEGORY__SUBCATEGORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.CATEGORY__SUBCATEGORIES,
